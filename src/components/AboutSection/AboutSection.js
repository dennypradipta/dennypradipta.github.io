                            ...
                            props.about.map(data => {
                                return (
                                    <div className="global-padding" key={data.sys.id}>
                                        ...
                                        <Heading size={4} className="has-text-left">{data.fields.name}</Heading>
                                        <Heading subtitle size={6} className="has-text-left has-text-grey">{data.fields.title}</Heading>
                                        <p className="has-text-left">{data.fields.description}</p>
                                        <Heading size={6} className="has-text-left has-text-grey">Preferred Technologies:</Heading>
                                        <Heading subtitle>
